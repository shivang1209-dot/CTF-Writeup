...
**Provided file:** [wallpaper.png](Resources/wallpaper.png)
...
Open the provided image [wallpaper.png](Resources/wallpaper.png). In the image or its metadata you may see a string that looks like part of a password:
...
There is **data after the PNG IEND** chunk.
...
The archive is password-protected. Use the string found in the image (`1n73rc3p7_c0nf1rm3d`):
...
After extraction, [fishwithwater/nothing.txt](Resources/fishwithwater/nothing.txt) contains the flag:
...
- **[Resources/wallpaper.png](Resources/wallpaper.png)** — Challenge image (trailer contains 7z archive).
- **[Resources/hidden.7z](Resources/hidden.7z)** — Extracted password-protected archive.
